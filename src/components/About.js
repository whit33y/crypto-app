        ...
        <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 sm:py-24">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold sm:text-4xl">
              About site and about me <span className="material-symbols-outlined text-4xl">token</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 lg:gap-16 lg:grid-cols-2">
            ...
            <div className="lg:py-16">
              <article className="space-y-4 text-gray-600 ">
                <p className='font-bold'>About site <span className="material-symbols-outlined">language</span></p>
                <p>
                ...
                <p className='font-bold'>About me <span className="material-symbols-outlined">emoji_people</span></p>
                <p>
                ...
                <p className='font-bold'>Used in this project <span className="material-symbols-outlined">supervised_user_circle</span></p>
                <p>
